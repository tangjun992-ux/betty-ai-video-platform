...
@router.get("/face-swap/templates", summary="换脸玩法模板（i2i 提示词，非 InsightFace）")
async def list_face_swap_templates():
    return {
        "templates": FACE_SWAP_TEMPLATES,
        "sku": FACE_SWAP_SKU,
        "mode": "i2i_edit",
        "cost_credits": FACE_SWAP_COST,
        "honesty": "提示词漏斗，仍需两张用户图；非 InsightFace/Roop 像素级换脸",
    }
