      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: isDragging
            ? "0 8px 24px -6px hsl(var(--brand) / 0.25)"
            : isFocused
            ? "0 6px 18px -6px hsl(var(--brand) / 0.18)"
            : undefined,
        }}
        className={cn(
      ...
      >
        ...
        <AnimatePresence>
          {isDragging && (
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 z-20 bg-brand/5 backdrop-blur-sm flex items-center justify-center"
          >
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-3 rounded-2xl bg-brand/10 border-2 border-dashed border-brand/30 flex items-center justify-center">
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    "bg-cosmic-elevated/90 text-text-secondary border border-cosmic-border/60"
                  )}
                >
        ...
        {multiShotMode && shots.length > 0 && (
          <div className="px-3 pt-3">
            ...
            <div className="flex gap-2 overflow-x-auto scrollbar-hide pb-1">
              ...
              <button
                onClick={onShotAdd}
                className="flex-shrink-0 w-12 h-16 rounded-lg border border-dashed border-cosmic-border/60 flex items-center justify-center hover:border-brand/30 hover:bg-brand/[0.03] transition-all"
              >
                ...
                >
                  <div className="p-3">
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="w-full bg-cosmic-subtle border border-cosmic-border rounded-lg px-3 py-2 text-body-sm text-text-primary placeholder:text-text-tertiary/50 resize-none focus:outline-none focus:border-brand/30 transition-all"
                    />
                  </div>
                </motion.div>
              );
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            {onOptimizePrompt && (
              <button
                ...
                className={cn(
                  "inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-caption whitespace-nowrap transition-all duration-200",
            ...
            >
              ...
              <span className="hidden sm:inline">绑定元素</span>
            </button>
            ...
            {onGenerateAudioChange && (
              ...
              >
                ...
                <span className="hidden sm:inline">生成音轨</span>
              </button>
            )}
            ...
            {onPostLipsyncChange && (
              ...
              >
                ...
                <span className="hidden sm:inline">完成后唇形</span>
              </button>
            )}
            ...
            {(references.filter((r) => r.type === "image").length > 1
              || references.some((r) => r.type === "video" || r.type === "audio")) && (
                <span className="inline-flex items-center gap-1 px-2 py-1 rounded-lg text-[10px] font-medium bg-brand/10 border border-brand/25 text-brand">
                Omni · 图≤9 视≤3 音≤3
              </span>
            )}
            ...
            <label
              className={cn(
                "inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-caption whitespace-nowrap cursor-pointer transition-all duration-200",
                "bg-cosmic-subtle border border-cosmic-border",
                "text-text-tertiary hover:text-text-secondary hover:bg-cosmic-subtle"
              )}
            >
      ...
      {suggestions.length > 0 && (
        <div className="flex flex-wrap gap-2">
          {suggestions.map((s, i) => (
            ...
            >
              <Wand2 className="w-3 h-3 inline mr-1 -mt-0.5 text-text-tertiary/70" />
              {s}
            </motion.button>
          ))}
        </div>
