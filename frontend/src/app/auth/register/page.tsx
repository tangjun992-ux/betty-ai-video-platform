...
export default function RegisterPage() {
  ...
  function validate() {
    ...
    else if (username.trim().length < 2) e.username = "用户名至少 2 个字";
    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(hsl(var(--brand)/0.5) 1px, transparent 1px), linear-gradient(90deg, hsl(var(--brand)/0.5) 1px, transparent 1px)",
