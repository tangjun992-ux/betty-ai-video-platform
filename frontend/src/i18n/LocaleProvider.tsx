...
export const dictionaries = {
  zh: {
    ...
    "nav.audio": "AI 音频", "nav.extract": "内容提取",
    "nav.productShots": "产品图", "nav.headshots": "职业头像", "nav.photoPacks": "写真包",
    ...
    "home.badge": "全球 15+ 顶级 AI 模型 · 一站式专业创作平台",
    "home.title1": "让每个创意", "home.title2": "一键成片",
    "home.subtitle": "对接全球顶级模型；只做导演，不写提示词 — 一句话描述，AI 自动规划→生成→精修",
  ...
  en: {
    ...
    "nav.audio": "AI Audio", "nav.extract": "Content Extract",
    "nav.productShots": "Product Shots", "nav.headshots": "Headshots", "nav.photoPacks": "Photo Packs",
    ...
    "home.badge": "15+ frontier AI models · one professional creation platform",
