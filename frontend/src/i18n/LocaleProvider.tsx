...
export const dictionaries = {
  zh: {
    ...
    "nav.generation": "创作", "nav.tools": "更多工具",
    "top.search": "搜索资产、工具或提示词…", "top.create": "立即创作",
    "top.settings": "设置", "top.dashboard": "控制台", "top.billing": "积分中心",
    "top.developer": "开发者 API", "top.mcp": "MCP / API", "top.logout": "退出登录", "top.login": "登录",
    "top.guest": "访客", "top.language": "English",
    "top.tools": "工具", "top.upgrade": "升级",
    ...
    "dashboard.placeholder": "描述你的创意…例如：温馨咖啡馆里的电影感产品视频，15 秒",
    "dashboard.promptMode": "Prompt 模式",
    "dashboard.helpPrompt": "优化提示词",
    "dashboard.createContent": "开始创作",
    "dashboard.helpIdeate": "帮我构思",
    "dashboard.generateAudio": "生成音频",
    ...
    "quote.queue": "队列前方",
    "quote.concurrent": "并发",
    "quote.refund": "失败自动退还积分",
    "quote.demo": "演示模式更快，不代表正式 SLA",
  ...
  en: {
    ...
    "nav.generation": "Generation", "nav.tools": "More tools",
    ...
    "top.developer": "Developer API", "top.mcp": "MCP / API", "top.logout": "Log out", "top.login": "Log in",
    "top.guest": "Guest", "top.language": "中文",
    "top.tools": "Tools", "top.upgrade": "Upgrade",
    ...
    "dashboard.question": "What do you want to create?", "dashboard.recent": "Recent creations",
    "dashboard.quick": "Quick tools", "dashboard.all": "View all",
    "dashboard.placeholder": "Describe your idea… e.g. a cinematic 15s product film in a warm café",
    "dashboard.promptMode": "Prompt mode",
    "dashboard.helpPrompt": "Help Prompt",
    "dashboard.createContent": "Create Content",
    "dashboard.helpIdeate": "Help Ideate",
    "dashboard.generateAudio": "Generate Audio",
    "agent.title": "Direct, don't write prompts",
    "agent.cta": "Start directing",
    "agent.preview": "Free preview",
    "agent.real": "Real generate",
    "quote.credits": "Est. credits",
    "quote.eta": "Est. time",
    "quote.queue": "Queue ahead",
    "quote.concurrent": "Concurrent",
    "quote.refund": "Failed jobs refund credits",
    "quote.demo": "Demo is faster — not a live SLA",
