  	...
  	extend: {
		...
		fontFamily: {
  		...
  		boxShadow: {
			...
			'glow-subtle': '0 4px 16px -6px hsl(172 66% 45% / 0.16)',
			'glow-medium': '0 8px 24px -6px hsl(172 66% 45% / 0.24)',
			'glow-strong': '0 12px 32px -8px hsl(172 66% 45% / 0.32)',
			'glow-cyan': '0 8px 24px -6px hsl(172 66% 45% / 0.24)',
			'glow-blue': '0 8px 24px -6px hsl(186 58% 46% / 0.24)',
			'glow-violet': '0 8px 24px -6px hsl(160 52% 44% / 0.24)',
			...
			card: '0 1px 3px 0 rgb(0 0 0 / 0.30), 0 1px 2px -1px rgb(0 0 0 / 0.25)',
			'card-hover': '0 12px 28px -6px rgb(0 0 0 / 0.45), 0 4px 10px -4px hsl(172 66% 45% / 0.08)',
			'card-active': 'inset 0 1px 3px 0 rgb(0 0 0 / 0.25)',
			'button-glow': '0 6px 20px -8px hsl(172 66% 45% / 0.40)',
			'button-glow-lg': '0 10px 28px -8px hsl(172 66% 45% / 0.45)'
  		},
  		keyframes: {
  			'fade-in-up': {
  				'0%': {
