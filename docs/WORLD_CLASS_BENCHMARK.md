...
|------|-------|---------|--------|---------|-------|-------------|---------|------|
| 产品工具矩阵 | **88** | 90 | 70 | 85 | 65 | 40 | 55 | Betty create 面齐全 |
...
| **加权综合** | **~76** | **~74** | **~72** | **~78** | **~58** | **~55** | **~72** | Betty≈Yapper 工程面；弱于 Runway 视频护城河 |
...
| **P2 样片库/OIDC/bootstrap** | **~76** | 配置面↑；出片/密钥仍缺 |
